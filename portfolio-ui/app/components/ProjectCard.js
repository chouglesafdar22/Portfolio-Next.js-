...
function ProjectCard({ image, title, description, onClick }) {
    return (
        <div onClick={onClick} className='flex flex-col cursor-pointer text-white hover:text-gray-300 hover:bg-gray-600 transition-all duration-300 items-center px-2 py-1 m-2 w-72 h-80 sm:w-80 sm:h-96 gap-5 ease-in-out rounded-lg shadow-lg shadow-indigo-800 hover:shadow-xl hover:shadow-gray-900 bg-indigo-500'>
