        ...
        <div className="container mx-auto flex px-10 pb-10 pt-20 text-center items-center justify-center flex-col">
          ...
          <div className="text-center lg:w-2/3 w-full">
            ...
            <div className="flex sm:flex-row flex-col justify-center gap-4">
              <Button icon={<IoNewspaperOutline />} title="Resume" hoverTextSize="hover:text-xl" textSize="text-lg" size={40} bgColor="bg-indigo-500" hoverTextColor="hover:text-gray-300" textColor="text-white" hoverSize="hover:w-44" hoverBgColor="hover:bg-gray-600" />
